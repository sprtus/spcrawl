...
var Scan = /** @class */ (function () {
    ...
    Scan.run = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var sites, webCount, _loop_1, _i, _a, siteUrl;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                                                ...
                                                return __generator(this, function (_c) {
                                                    switch (_c.label) {
                                                        case 0:
                                                            ...
                                                            _c.label = 1;
                                                        case 1:
                                                            if (!webUrls.length) return [3 /*break*/, 4];
                                                        ...
                                                        case 2:
                                                            response = _c.sent();
                                                            webData = lodash_1.default.clone(IWeb_1.NewWeb);
                                                            for (_i = 0, _a = Object.keys(IWeb_1.NewWeb); _i < _a.length; _i++) {
                                                                prop = _a[_i];
                                                                webData[prop] = response[prop];
                                                            }
                                                        ...
                                                        case 3:
                                                            ...
                                                            for (_b = 0, subwebs_1 = subwebs; _b < subwebs_1.length; _b++) {
                                                                subweb = subwebs_1[_b];
                    ...
                    case 4:
                        // Write to file
                        console.log("Found " + webCount + " webs in " + sites.length + " sites.\n  " + Utility_1.Utility.path('webs.json'));
                        try {
