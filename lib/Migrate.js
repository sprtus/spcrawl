                                    ...
                                    case 0:
                                        ...
                                        return [4 /*yield*/, new sp_pnp_node_1.PnpNode().init().then(function (settings) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    ...
                                                    web = new pnpjs_1.Web(siteUrl + "/policies-forms/policies-procedures");
                                                    pages = web.lists.getByTitle('Pages').items.get().catch(function (e) { return console.error; });
                                                    console.log(pages);
                                                    return [2 /*return*/];
                                                });
                                            }); }).catch(console.error)];
